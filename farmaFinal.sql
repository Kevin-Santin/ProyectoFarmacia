...
-- desligar medicamento de detalle pedido
-- Manejar solo comprapedido
-- Precio Medicamento y precioProducto no debe estar en detalle
-- agregar campo de cantidad en detallecompracliente
-- campo pedido a la compra del cliente.
...
constraint foreign key (id) references producto(idProucto)
);
-- ===============================================--
